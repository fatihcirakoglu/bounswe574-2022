...
((function() {
    ...
    Annotator.Plugin.Offline = a = function(a) {
        function g() {
            ...
            var a, e, f;
            g.__super__.constructor.apply(this, arguments), this.store = new g.Store, this.cache = {}, f = {
                online: "online",
                offline: "offline",
            ...
            for (a in f) {
                ...
                e = f[a], typeof this.options[e] == "function" && this.on(a, b.proxy(this.options, e))
            }
        }
        var b, f;
        return e(g, a), f = Annotator._t, b = Annotator.$, g.ANNOTATION_PREFIX = "annotation.", g.uuid = function() {
            ...
            return this.loadAnnotationsFromStore(), this.isOnline() ? this.online() : this.offline(), b(window).bind({
            ...
            var a, b, c, d, e;
            c = [], b = this.store.all(g.ANNOTATION_PREFIX);
            for (d = 0, e = b.length; d < e; d++) {
                a = b[d];
                if (!this.options.shouldLoadAnnotation(a)) continue;
                this.publish("beforeAnnotationLoaded", [a, this]), this.publish("annotationLoaded", [a, this]), this.cache[this.keyForAnnotation(a)] = a, c.push(a)
            }
            return c.length && this.annotator.loadAnnotations(c), this
        }, g.prototype.addAnnotation = function(a, b) {
            var c;
            return b == null && (b = {}), c = this.cache[this.options.getUniqueKey(a)], !c && this.options.shouldLoadAnnotation(a) ? this.annotator.setupAnnotation(a, b.silent) : this.updateStoredAnnotation(a), this
        }, g.prototype.removeAnnotation = function(a) {
            return this.options.shouldLoadAnnotation(a) ? this.annotator.deleteAnnotation(a) : this.removeStoredAnnotation(a), this
        }, g.prototype.updateStoredAnnotation = function(a) {
            var c, d, e, f;
            return c = this.keyForAnnotation(a), d = this.keyForStore(a), e = this.cache[c], e ? b.extend(e, a) : e = this.cache[c] = a, f = b.extend({}, e), delete f.highlights, this.store.set(d, f), this
        }, g.prototype.removeStoredAnnotation = function(a) {
            var b, c;
            return b = this.keyForAnnotation(a), c = this.keyForStore(a), this.store.remove(c), delete this.cache[b], this
    ...
    }(Annotator.Plugin), Annotator.Plugin.Offline.Store = b = function(a) {
        function b() {
            b.__super__.constructor.apply(this, arguments)
        }
        return e(b, a), b.KEY_PREFIX = "annotator.offline/", b.CACHE_DELIMITER = "--cache--", b.localStorage = window.localStorage, b.isSupported = function() {
            try {
            ...
            for (c in localStorage) {
                ...
                e = this.get(c.slice(b.KEY_PREFIX.length)), f.push(e)
            }
            return f
        }, b.prototype.get = function(a) {
            var c;
            //c = b.localStorage.getItem(this.prefixed(a)), c && (c = this.checkCache(c), c || this.remove(a)), JSON.parse(c);
            //console.log("deneme574-getitem" + JSON.stringify(c));
            //return c;
            ...
            c = JSON.stringify(c), d && (c = b.now() + d + b.CACHE_DELIMITER + c);
            try {
                b.localStorage.setItem(this.prefixed(a), c)
                //console.log("deneme574-setitem" + JSON.stringify(c));
            } catch (e) {
            ...
            var c;
            return a.indexOf(b.CACHE_DELIMITER) > -1 && (c = a.split(b.CACHE_DELIMITER), a = b.now() > c.shift() ? null : c.join(b.CACHE_DELIMITER)), a
        }, b
    }(Annotator.Delegator)
})).call(this);